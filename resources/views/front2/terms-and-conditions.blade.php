                    ...
                    <div>
                        <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                            <div class="uk-grid" data-uk-grid>
                                ...
                                <div class="uk-width-expand@m in-margin-small-top@s">
                                    <h4 class="uk-margin-small-bottom">Links To Other Web Sites</h4>

                                    <p class="uk-text-small uk-margin-remove-bottom">

                                        Our Service may contain links to third-party web sites or services that are not owned or controlled by Profit Trending. Profit Trending has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Profit Trending shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.<br>
...
<div>
    <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
        <div class="uk-grid" data-uk-grid>
            ...
            <div class="uk-width-expand@m in-margin-small-top@s">
                <h4 class="uk-margin-small-bottom">Termination</h4>
