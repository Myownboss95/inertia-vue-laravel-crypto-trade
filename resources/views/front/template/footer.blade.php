        ...
        <div class="uk-container">
            <div class="uk-grid-medium" data-uk-grid>
                <div class="uk-width-expand@m">
                    <img class="uk-margin-small-right in-margin-top-30@s" src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-logo-2.svg')}}" alt="wave" width="134" height="23" data-uk-img>
                            ...
                            <div class="uk-grid-small uk-flex uk-child-width-1-4@s uk-flex uk-child-width-1-5@m in-payment-method uk-text-center" data-uk-grid>
                                <div>
                                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                        <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-visa.svg')}}" alt="wave-payment" width="59" height="22" data-uk-img>
                                    </div>
                                </div>
                                <div>
                                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                        <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-mastercard.svg')}}" alt="wave-payment" width="59" height="22" data-uk-img>
                                    </div>
                                </div>
                                <div>
                                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                        <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-skrill.svg')}}" alt="wave-payment" width="59" height="22" data-uk-img>
                                    </div>
                                </div>
                                <div>
                                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                        <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-paypal.svg')}}" alt="wave-payment" width="59" height="22" data-uk-img>
                                    </div>
                                </div>
                                <div>
                                    <div class="uk-card uk-card-default uk-card-small uk-card-body uk-visible@m">
                                        <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-neteller.svg')}}" alt="wave-payment" width="59" height="22" data-uk-img>
                                    </div>
                                </div>
                            </div>
                        </div>
