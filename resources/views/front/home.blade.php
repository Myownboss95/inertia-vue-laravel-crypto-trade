...
@include('front.template.header')
    ...
    <main>
                ...
                <ul class="uk-slideshow-items uk-light">
                    <li>
                        <div class="uk-position-cover">
                            <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-slideshow-image-1.jpg')}}" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                        </div>
                        <span></span>
                        <div class="uk-container">
                    ...
                    <li>
                        <div class="uk-position-cover">
                            <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-slideshow-image-2.jpg')}}" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                        </div>
                        <span></span>
                        <div class="uk-container">
                            <div class="uk-grid" data-uk-grid>
                    ...
                    <li>
                        <div class="uk-position-cover">
                            <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-slideshow-image-3.jpg')}}" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                        </div>
                        <span></span>
                        <div class="uk-container">
                            <div class="uk-grid" data-uk-grid>
            ...
            <div class="uk-container in-wave-1">
                <div class="uk-grid uk-grid-divider uk-child-width-1-2@s uk-child-width-1-4@m in-margin-top@s in-margin-bottom@s" data-uk-grid>
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-1.svg')}}" alt="wave-icon" width="48" height="48" data-uk-img>
                            </div>
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-2.svg')}}" alt="wave-icon" width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand">
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-3.svg')}}" alt="wave-icon" width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand">
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-4.svg')}}" alt="wave-icon" width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand">
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
                    <div class="uk-width-1-2@m">
                        <img class="uk-margin-bottom" src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-5.svg')}}" alt="wave-icon" width="64" height="64" data-uk-img>
                        ...
                        <div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m uk-text-center uk-margin-medium-top" data-uk-grid>
                            <div>
                                <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                                    <img class="uk-margin-remove-bottom" src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-6.svg')}}" alt="wave-icon" width="52" height="52" data-uk-img>
                                    <h5 class="uk-margin-small-top">Strategies &amp; Discussions</h5>
                                </div>
                            </div>
                            <div>
                                <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                                    <img class="uk-margin-remove-bottom" src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-icon-7.svg')}}" alt="wave-icon" width="52" height="52" data-uk-img>
                    ...
                    <div class="uk-width-1-2@m">
                        <div class="uk-inline uk-dark in-wave-video uk-margin-small-bottom">
                            <img class="uk-border-rounded uk-width-1-1" src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-image-1.jpg')}}" alt="wave-video" width="533" height="355" data-uk-img>
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    ...
                    <div class="uk-width-1-1">
                        <div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-5@m uk-text-center uk-margin-large-top" data-uk-grid>
                            <div>
                                <img src="{{asset('front/img/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-award.svg')}}" alt="wave-award" width="71" height="58" data-uk-img>
                            ...
                            <div>
                                <img src="{{asset('frontimg/in-lazy.gif')}}" data-src="{{asset('front/img/in-wave-award.svg')}}" alt="wave-award" width="71" height="58" data-uk-img>
        ...
        <div class="uk-section uk-section-default uk-padding-remove-vertical in-wave-5 in-offset-bottom-40">
            <div class="uk-container">
                <div class="uk-grid">
                    <div class="uk-width-1-1 uk-background-contain uk-background-center-right uk-background-image@m" style="background-image: url({{asset('front/img/in-wave-mockup-1.png')}});">
