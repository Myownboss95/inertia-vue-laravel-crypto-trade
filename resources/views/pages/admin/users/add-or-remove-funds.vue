...
const current_balance = computed(
  () =>
    "Current Bal: " + format_money.methods.format_money(props.current_balance)
);
const action = ref(0);
    ...
    onBefore: () =>
      confirm(
        `Are you sure you want to ${
          action.value == 1 ? "add funds to" : "deduct funds from"
        } user?`
      ),
